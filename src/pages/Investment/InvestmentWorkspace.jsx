...
const SalesWorkspace = () => {
  ...
  const handleLeadClick = (lead) => {
    ...
    setFormData({
      ...
      investmentCapital: lead.investmentCapital || '',
    ...
    <DashboardLayout>
      <div className="sales-workspace">
        <div className="page-header">
          <div>
            <h1>Espacio de Inversiones</h1>
            <p className="text-secondary">Gestiona tus leads de inversión asignados</p>
          </div>
                ...
                <div className="info-section">
                  ...
                  {editMode ? (
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="input-group">
                          ...
                          <input
                            type="text"
                            className="input"
                            value={formData.interbankAccount}
                            onChange={(e) => setFormData({ ...formData, interbankAccount: e.target.value })}
                    ...
                    <div className="info-grid">
                      ...
                      <div className="info-field">
                        <label><DollarSign size={16} /> Capital a Invertir</label>
                        <p>{formData.investmentCapital ? `S/ ${formData.investmentCapital}` : 'No especificado'}</p>
                      </div>
                      <div className="info-field">
                        <label><User size={16} /> Estado Civil</label>
                        <p>{formData.maritalStatus ? formData.maritalStatus.charAt(0).toUpperCase() + formData.maritalStatus.slice(1) : 'No especificado'}</p>
                      </div>
                      <div className="info-field">
                        <label><CreditCard size={16} /> Banco</label>
                        <p>{formData.bankName || 'No especificado'}</p>
                      </div>
                      <div className="info-field">
                        <label><CreditCard size={16} /> Cuenta Bancaria</label>
                        <p>{formData.accountNumber || 'No especificado'}</p>
                      </div>
                      <div className="info-field">
                        <label><CreditCard size={16} /> Cuenta Interbancaria</label>
                        <p>{formData.interbankAccount || 'No especificado'}</p>
                      </div>
                      <div className="info-field">
